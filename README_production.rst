...
`Quickstart Guide <https://github.com/A2/online\_test/blob/master/README.rst>`__
...
Follow these steps to deploy locally on the server. For deployment instructions using Docker see `Deploying Multiple Dockers <https://github.com/A2/online_test/blob/add-docker-compose-test/README_production.rst#deploying-multiple-dockers>`__
...
6. Run the python server provided. This ensures that the code is
    ...
    *before* students start attempting the exam. Using sudo is necessary
    ...
    see :ref:`Dockerized Code Server <https://github.com/A2/online_test/blob/add-docker-compose-test/README_production.rst#using-dockerized-code-server>`__
