...
class WardType(admin.TabularInline):
    model = Ward
...
class AttendanceCourseType(admin.TabularInline):
    model = AttendanceCourse

class AttendanceAdmin(admin.ModelAdmin):
    list_display = ('user', 'date','start_time', 'end_time', 'group')
    inlines = [AttendanceCourseType,]
